...
public class UploadQuestionPapers extends AppCompatActivity {
    CardView addPdf;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_question_papers);
        ...
        ArrayAdapter<String> adapter = (new ArrayAdapter<String>(UploadQuestionPapers.this, android.R.layout.simple_spinner_dropdown_item, item));
        ...
        uploadPdfButoon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(title.isEmpty()){
                    ...
                    Toast.makeText(UploadQuestionPapers.this, "Please select category", Toast.LENGTH_LONG).show();
                } else if (pdfData == null) {
                    Toast.makeText(UploadQuestionPapers.this, "Please upload pdf file", Toast.LENGTH_LONG).show();
                } else {
                    uploadPdf();
                }
            }
    ...
    private void uploadPdf() {
        ...
        reference.putFile(pdfData).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onFailure(@NonNull Exception e) {
                pd.dismiss();
                Toast.makeText(UploadQuestionPapers.this, "error in upload pdf", Toast.LENGTH_LONG).show();
            }
        });
    ...
    private void uploadData(String downloadUrl) {
        ...
        dbRef.child(uniqueKey).setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                pd.dismiss();
                Toast.makeText(UploadQuestionPapers.this, "upload pdf", Toast.LENGTH_LONG).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                pd.dismiss();
                Toast.makeText(UploadQuestionPapers.this, "error....", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if (requestCode == REQ && resultCode == RESULT_OK) {
            ...
            if (pdfData.toString().startsWith("content://")) {
                Cursor cursor = null;
                cursor = UploadQuestionPapers.this.getContentResolver().query(pdfData, null, null, null, null);
