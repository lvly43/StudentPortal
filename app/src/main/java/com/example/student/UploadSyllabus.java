...
public class UploadSyllabus extends AppCompatActivity {
...
private ProgressDialog pd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = (new ArrayAdapter<String>(UploadSyllabus.this, android.R.layout.simple_spinner_dropdown_item, item));
        ...
        uploadPdfButoon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(title.isEmpty()){
                    ...
                    Toast.makeText(UploadSyllabus.this, "Please select category", Toast.LENGTH_LONG).show();
                } else if (pdfData == null) {
                    Toast.makeText(UploadSyllabus.this, "Please upload pdf file", Toast.LENGTH_LONG).show();
                } else {
                    uploadPdf();
                }
            }
    ...
    private void uploadPdf() {
        ...
        reference.putFile(pdfData).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onFailure(@NonNull Exception e) {
                pd.dismiss();
                Toast.makeText(UploadSyllabus.this, "error in upload pdf", Toast.LENGTH_LONG).show();
            }
        });
    ...
    private void uploadData(String downloadUrl) {
        ...
        dbRef.child(uniqueKey).setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                pd.dismiss();
                Toast.makeText(UploadSyllabus.this, "upload pdf", Toast.LENGTH_LONG).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                pd.dismiss();
                Toast.makeText(UploadSyllabus.this, "error....", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if (requestCode == REQ && resultCode == RESULT_OK) {
            ...
            if (pdfData.toString().startsWith("content://")) {
                Cursor cursor = null;
                cursor = UploadSyllabus.this.getContentResolver().query(pdfData, null, null, null, null);
